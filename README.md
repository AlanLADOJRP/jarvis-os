...
JARVIS OS is a modular personal AI operating system built with Next.js App Router, TypeScript, Tailwind CSS, Prisma ORM, PostgreSQL, OpenAI, and Zod.

## What this app does

- Tracks nutrition from natural-language chat
- Starts the Nutrition and Gym modules for a larger personal OS
...
- Shows nutrition and gym calendars as the first OS-style dashboards
...
- Nutrition is the first production module.
- Gym data, calendars, and summaries are scaffolded for the next module.
- The dashboard is designed as a home screen for future modules like Tasks, Water, and Activity.
